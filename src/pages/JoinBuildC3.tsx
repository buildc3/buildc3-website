...
function FloatingCards() {
  return (
    <div className="hidden lg:flex flex-col gap-3 absolute right-8 top-1/2 -translate-y-1/2 z-10">
      <div className="bg-white/10 backdrop-blur-sm border border-white/10 rounded-2xl p-4 w-52 text-white">
      ...
      <div className="bg-white/5 border border-white/10 rounded-2xl p-4 w-52 text-white">
  ...
  if (status === "success") {
    return (
      <div className="text-center py-8">
        ...
        <p className="text-white/50 text-sm">We'll definitely reach out to you soon.</p>
      </div>
    );
  }
