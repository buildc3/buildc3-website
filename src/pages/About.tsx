    ...
    <main className="min-h-screen bg-background">
      ...
      <section className="mx-auto max-w-7xl px-6 pt-16 pb-20">
        ...
        {isLoading ? (
          ...
          <div className="text-left text-muted-foreground py-16">
            <p className="text-base md:text-lg">
              We are still in our pre-launch phase, and will be launching soon. Make sure to join the waitlist to hear from us soon and rocket launch your idea!
            </p>
            <Link
              to="/join"
              className="inline-flex items-center justify-center mt-6 px-5 py-2.5 rounded-xl bg-primary text-primary-foreground text-xs font-bold uppercase tracking-widest hover:opacity-90 transition"
            >
              Join Waitlist
            </Link>
          </div>
